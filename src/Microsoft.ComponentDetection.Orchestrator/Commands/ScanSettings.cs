...
public class ScanSettings : BaseSettings
{
    ...
    public IEnumerable<string> DirectoryExclusionList { get; set; } = new List<string>();
    ...
    public IEnumerable<string> DirectoryExclusionListObsolete { get; set; } = new List<string>();
    ...
    [TypeConverter(typeof(CommaDelimitedConverter))]
    public IEnumerable<string> DetectorCategories { get; set; } = new List<string>();
    ...
    public IEnumerable<string> DockerImagesToScan { get; set; } = new List<string>();
}
